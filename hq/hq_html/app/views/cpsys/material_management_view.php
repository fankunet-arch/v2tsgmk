...
<div class="offcanvas offcanvas-end" tabindex="-1" id="material-drawer" aria-labelledby="drawer-label">
    ...
    <div class="offcanvas-body">
        <form id="material-form">
            ...
            <div class="mb-3">
                <label for="image-url" class="form-label">物料图片 URL (可选)</label>
                <input type="text" class="form-control" id="image-url" name="image_url" placeholder="https://...">
                <div class="form-text">用于 KDS SOP 步骤卡片上的图片显示。</div>
            </div>
            <hr>
