 ...
 * Version: 1.1.001 (Merged SIF Declaration logic into pos_settings)
 * Date: 2025-11-04
 */
...
function handle_invoice_cancel(PDO $pdo, array $config, array $input_data): void {
    ...
    try {
        ...
        if (!$handler_path || !file_exists($handler_path)) throw new Exception("Compliance handler for '{$compliance_system}' not found");
