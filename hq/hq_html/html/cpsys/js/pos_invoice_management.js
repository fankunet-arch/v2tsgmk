 ...
 * Engineer: Gemini | Date: 2025-10-26 | Revision: 3.2 (Correction API Integration)
 */
$(document).ready(function() {
    ...
    $('#btn-confirm-cancellation').on('click', function() {
        ...
        $.ajax({
            url: 'api/cancel_invoice.php',
            type: 'POST',
            contentType: 'application/json',
            data: JSON.stringify({ id: invoiceId, reason: reason }),
            dataType: 'json',
