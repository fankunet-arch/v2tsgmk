 ...
 * Date: 2025-11-08
 *
 * [B1.3.1 PASS]: Added require_once and array_merge for pos_registry_ext_pass.php
 */
...
$registry_main = require_once __DIR__ . '/registries/pos_registry.php';

// [B1.3.1 PASS] 加载次卡核销扩展注册表
$registry_ext_pass = require_once __DIR__ . '/registries/pos_registry_ext_pass.php';

// [B1.3.1 PASS] 合并注册表 (扩展优先，以便覆盖)
