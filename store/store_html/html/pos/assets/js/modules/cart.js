 ...
 * - V3 (Phase 4.1): addToCart 时注入 KDS 机器码 (product_code, cup_code)
 */
...
export function addToCart() {
    ...
    // --- START V3 (Phase 4.1) MODIFICATION ---
    STATE.cart.push({
        id: `item_${Date.now()}`,
        ...
        // KDS 机器码 (用于打印和SOP)
        product_code: variant.recipe_sku || null, // recipe_sku 即 product_code
        cup_code: variant.cup_code || null,     // 由 data_loader (Phase 4.1.A) 新增
        ice: ice, // ice code (e.g., "1")
        sugar: sugar, // sugar code (e.g., "1")
